		...
		\begin{frame}
		  \frametitle{\textbf{SMS的恶意应用}}
            ...
            \begin{columns}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=1.0\textwidth]{figures/figure9.png}
                    \caption{SMS地址分布}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=1.0\textwidth]{figures/figure10.png}
                    \caption{钓鱼短信实例}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=1.0\textwidth]{figures/figure11.png}
                    \caption{钓鱼网站}
            ...
            \begin{frame}
                ...
                \begin{center}
                    \begin{minipage}{1\textwidth}
                        \setbeamercolor{mybox}{fg=white, bg=cufeblue}
                ...
                \begin{columns}[c]
                    ...
                    \column{.12\textwidth}
                    \centering
                    \includegraphics[width=\textwidth]{figures/figure12.png}

                    \column{.78\textwidth}
                    \centering
                    LaTeX Beamer template open source on Github now!\\
                    \vspace{0.3em}
                    \url{https://github.com/z-my-cn/CUFE-Beamer-Slide}\\
                    \vspace{0.3em}
